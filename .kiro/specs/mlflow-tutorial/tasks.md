...
- [ ] 2. (P) MLflowコア概念説明ノートブックの実装
- [ ] 2.1 4コンポーネント説明コンテンツの実装
...
- [ ] 4.2 mlflow.pytorch.log_modelによるモデル保存とロードの実装
...
- [ ] 5. (P) Optuna HPO・実験比較ノートブックの実装
- [ ] 5.1 Optuna + MLflow Tracking統合の実装
...
- [ ] 6. チャンピオン/チャレンジャー管理ノートブックの実装
- [ ] 6.1 エイリアスAPIを使ったモデル登録とエイリアス付与の実装
...
- [ ] 7. FastAPI Webアプリの実装
- [ ] 7.1 lifespanによるチャンピオンモデルロードの実装
...
- [ ] 7.2 /predictおよび/healthエンドポイントの実装
...
- [ ] 8. (P) GitHub Actions CI/CDワークフローの構築
